                                ...
                                <div className='flex flex-col gap-3 w-full justify-evenly'>
                                    <div className='flex gap-2'>
                                        ...
                                        <div className='flex flex-col gap-2 w-full' >
                                            <div className='flex justify-between w-full items-center'  >
                                                <h1 className='text-xl font-bold text-gray-800 ' >Untitled Draft</h1>
                                                <Dropdown icon={<svg
                                    ...
                                    <div className='flex justify-between items-center' >
                                        {/* <div class='flex gap-4'>
                                            <button className='bg-red-100/50 text-gray-800 flex items-center gap-1 p-1 px-2 rounded-md text-sm font-bold' > 0 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                            ...
                                            <button className='bg-red-100/50 text-gray-800 flex items-center gap-2 p-1 px-2 rounded-md text-sm font-bold' > 0  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 0 1 .865-.501 48.172 48.172 0 0 0 3.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z" />
                                            </svg></button>
                                        </div> */}
                                        <div className='flex gap-2' >
                                            {["Thriller", "Horror", "Suspense", "Fiction", "Self Help"].map(genre => <span className='bg-red-100/50 text-gray-600 px-3 rounded-full py-1 text-xs font-bold'>   # {genre}  </span>)}
                                        </div>
                                    </div>
                                </div>
                            </div>
