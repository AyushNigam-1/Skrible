            ...
            <div className='grid grid-cols-2 gap-5' >
                {
                    data.getScriptById.paragraphs.map((para) => {
                        return <div className='flex-col flex justify-between bg-gray-100  gap-2 p-2 rounded-lg relative' >
                            <div className='flex gap-2 items-center' >
                                <div className='flex flex-col gap-3'>
                                    ...
                                    <div className='flex gap-2 w-full bg-white p-2 rounded-lg ' >
                                        <p className='text-lg text-gray-600 line-clamp-4' > {para.text} </p>
                                    </div>
                                </div>
                            </div>
