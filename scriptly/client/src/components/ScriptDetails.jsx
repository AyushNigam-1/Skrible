        ...
        <div className='col-span-2 sticky top-6 h-min bg-gray-200/50 rounded-lg p-4 gap-3 flex flex-col' >
            <div className='flex gap-1 flex-col'>
                ...
                <span className='flex items-center gap-2' >
                    <p className='text-lg font-semibold text-gray-800' >{data?.getScriptById.title}</p>
                </span>
            </div>
            <hr />
            <div className='flex gap-1 flex-col'>
                <h4 className='text-md text-gray-600 font-medium flex items-center gap-1' >
                    ...
                    Description </h4>
                <span className='flex items-center gap-2' >
                    <p className='text-lg font-semibold text-gray-800' >{data?.getScriptById.description}</p>
                </span>
            </div>
            <hr />
            <div className='flex gap-1 flex-col'>
                ...
                <div className='flex gap-3 flex-wrap' >
                    {
                        data?.getScriptById.languages.map((language) => {
                            return <p className='text-lg font-semibold text-gray-800 py-1 px-2 bg-white rounded-xl' > {language}  </p>
                        })
                    }
                </div>
            </div>
                ...
                <div className='flex gap-3 flex-wrap' >
                    {
                        data?.getScriptById.genres.map((genre) => {
                            return <p className='text-lg font-semibold text-gray-800 py-1 px-2 bg-white rounded-xl' > # {genre}  </p>
                        })
                    }
                </div>
            </div>
