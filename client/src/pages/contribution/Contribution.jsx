...
const ContributionDetail = () => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-6xl mx-auto">
      ...
      <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-gray-800 p-4 rounded-2xl shadow-sm flex flex-col gap-5 shrink-0">
        <div className="flex items-center gap-4">
          <div className="px-3 py-3 rounded-full bg-white/5 flex items-center justify-center text-white font-bold text-lg shadow-inner">
        ...
        <div className="bg-gray-50 dark:bg-white/5 rounded-xl p-5 md:p-6 border border-gray-100 dark:border-gray-800">
      ...
      <div
        ...
        className="flex flex-col bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden"
        style={{ height: commentsHeight || "50vh" }}
      >
        <div className="bg-white dark:bg-white/5 border-b border-gray-200 dark:border-gray-800 p-4 shrink-0 flex items-center gap-2">
          ...
          {localComments.length > 0 ? (
            localComments.map((comment, index) => (
              ...
              <div key={index} className="flex gap-3 items-start">
                ...
                <div className="w-8 h-8 shrink-0 rounded-full bg-white/5 flex items-center justify-center text-white font-bold text-xs mt-1">
                  {comment.author?.username?.charAt(0).toUpperCase()}
                </div>

                {/* CHANGED: Added background, padding, border, and border-radius directly to the text bubble */}
                <div className="flex flex-col w-full bg-white dark:bg-white/5 p-4 rounded-2xl rounded-tl-sm border border-gray-800 dark:border-white-5 shadow-sm">
        ...
        {/* Comment Input Area */}
        <div className="p-4 bg-white dark:bg-white/5 border-t border-gray-200 dark:border-gray-800 shrink-0">
          <div className="relative flex items-center">
            <input
              ...
              className="w-full bg-gray-100 dark:bg-white/5 border border-transparent focus:border-blue-500 text-gray-900 dark:text-white rounded-xl py-3 pl-4 pr-12 outline-none transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 disabled:opacity-50"
