        ...
        <div className='grid grid-cols-2 gap-5'>
            {
                data?.getAllScripts?.map(e => {
                    return (
                        <div className='bg-gray-100 rounded-lg p-3 flex  gap-4 shadow h-full' >
                            <Link to={`script/${e.id}`} className='flex flex-col gap-3 w-full justify-between'>
                                <div className='flex gap-2'>
                                    ...
                                    <div className='flex flex-col gap-2 w-full' >
                                        ...
                                        {/* <div className='flex gap-2' >
                                            ...
                                            <span className='flex items-center gap-1 bg-white text-black-800 px-3 py-1 rounded-full w-max' >
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-3">
                                ...
                                <div className="flex flex-wrap gap-2 mt-auto">
                                    {e.genres.map((genre) => (
                                        <span key={genre} className="bg-white  text-gray-600 px-3 rounded-full py-1 text font-semibold">
                                            # {genre}
                                        </span>
                                    ))}
                                </div>
