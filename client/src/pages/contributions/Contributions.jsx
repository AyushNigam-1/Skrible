    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-5">
        {data.getScriptById.paragraphs.map((para) => {
          return (
            <div
              className="flex-col flex justify-between bg-gray-200/50  gap-2 p-2 rounded-lg relative"
              key={para.id}
            >
                ...
                <div className="flex justify-between items-center">
                  <div className="flex gap-2">
                    <img
                      ...
                      src="https://www.fufa.co.ug/wp-content/themes/FUFA/assets/images/profile.jpg"
                      alt="Bonnie image"
                    />
                    <div className="">
