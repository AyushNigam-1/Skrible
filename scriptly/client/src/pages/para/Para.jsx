    ...
    return (
        <div className='flex flex-col gap-2 container mx-auto' >
            <div className='bg-white p-4 flex gap-4' >
                <img className="w-20 h-20 rounded-md" src="https://tecdn.b-cdn.net/img/new/avatars/2.webp" alt="Rounded avatar" />
            ...
            <div className='bg-white p-4 rounded-lg gap-2 flex-col flex' >
                <p className=' text-xl text-gray-800' >
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi possimus iure odit ut, facere voluptas harum sunt? Iusto sunt in aliquam dolores? Fugit voluptate quod dolorem incidunt voluptates nisi esse! Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus natus consequuntur dolorem.
                </p>
