                            ...
                            <Link to={`script/${e.id}`} className='flex flex-col gap-3 w-full justify-between'>
                                <div className='flex gap-2'>
                                    ...
                                    <div className='flex flex-col gap-4 w-full' >
                                        ...
                                        <div className='flex gap-2' >
                                            <span className='flex items-center gap-1 bg-white text-gray-500 px-3 py-0.5 rounded-full w-max' >
                                            ...
                                            <span className='flex items-center gap-1 bg-white text-gray-500 px-3 py-1 rounded-full w-max' >
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                                            ...
                                            <span className='bg-white text-gray-500 py-1 px-3 rounded-full flex gap-1 items-center'>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                                ...
                                <div className="flex flex-wrap gap-2 mt-auto">
                                    {e.genres.map((genre) => (
                                        <span key={genre} className="bg-white flex gap-2 items-center  text-gray-600 px-3 rounded-full py-1 text-sm font-semibold">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
