...
const Contributions = () => {
    return (
        <div className='flex container m-auto flex-col gap-8' >
            ...
            {
                Array(5).fill(0).map(() => {
                    return <div className='flex justify-between bg-white  gap-2 p-2 rounded-lg relative pb-6' >
                        ...
                        <div className='flex gap-2 absolute left-2 -bottom-4 '>
                            <button className='flex gap-2 border bg-white  border-gray-300 rounded-full shadow-md p-2 text-green-800'>
                                <p>1</p>
                            ...
                            <button className='flex gap-2 rounded-full  bg-white border border-gray-300 shadow-md p-2 text-red-800'>
                                <p>1</p>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            ...
                            <button className='flex gap-2 rounded-full  bg-white border border-gray-300 shadow-md p-2 text-indigo-800'>
                                <p>1</p>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
