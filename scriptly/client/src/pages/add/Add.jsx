            ...
            <Dialog as="div" className="relative z-50 font-mono" onClose={() => setOpen(false)}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <DialogPanel className="w-full max-w-3xl transform overflow-hidden rounded-xl bg-gray-700 text-left align-middle shadow-2xl  transition-all font-inter text-white relative p-6 space-y-5 max-h-[90vh] overflow-y-auto">
                                <form onSubmit={handleSubmit} className="flex gap-3 flex-col">
                                    <div className="flex justify-between items-center">
                                        <h3 className="text-2xl font-black text-gray-100">Add New Script</h3>
                                        <button
                    ...
                    <img src="/person.jpg" className="rounded-full w-52" alt="" />
                                        ...
                                        <div className="rounded-md  w-full shadow-sm flex gap-2 flex-col">
                                            <div className="flex gap-3">
                                                ...
                                                /> */}
                                                        ...
                                                        <ListboxOptions
                                                            ...
                                                            transition
                                                            className={clsx(
                                                                'w-[var(--button-width)] rounded-lg border mt-3 flex flex-col p-2 [--anchor-gap:var(--spacing-1)] focus:outline-none text-gray-600',
                            ...
                            >
                                ...
                                <option value="EC">Eric Clapton</option>
                                    ...
                                    <div className="flex gap-3">
                                        <button
                                            type="submit"
                                            className="flex gap-2 items-center text-lg  text-gray-600 text-md py-4 px-6 rounded-lg"
