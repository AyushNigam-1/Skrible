...
const Profile = () => {
    ...
    const userDetails = [
        {
            title: 'Name',
            value: data?.getUserProfile?.username || 'Not provided',
            svg: (
                <svg
        ...
        {
            title: 'Languages',
            value: data?.getUserProfile?.languages?.join(', ') || 'Not provided',
            svg: (
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
        ...
        {
            title: 'Bio', value: data?.getUserProfile?.bio || 'Not provided', svg: (
        ...
        {
            title: 'Email', value: data?.getUserProfile?.email || 'Not provided', svg: (
        ...
        {
            title: 'Intrests', value: data?.getUserProfile?.email || 'Not provided', svg: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
    ...
    const sidebarInfo = [{
        title: 'Views', value: data?.getUserProfile?.views.length || 0, svg: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
    ...
    {
        title: 'Likes', value: data?.getUserProfile?.likes.length || 0, svg: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
    ...
    {
        title: 'Followers', value: data?.getUserProfile?.followers.length || 0, svg: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <div className='flex rounded-md gap-3' >
                <div className='flex flex-col gap-3 w-64 bg- p-4 rounded-lg bg-gray-200/50' >
                    ...
                    <div className='flex gap-3 flex-col'>
                        ...
                        {username != data.getUserProfile.username && <button className='flex gap-2 items-center justify-center p-2 rounded-lg bg-white shadow-md text-gray-600 font-bold' > <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
