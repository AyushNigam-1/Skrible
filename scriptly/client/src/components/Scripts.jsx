                                ...
                                <div className='flex flex-col gap-5 w-full justify-evenly'>
                                    ...
                                    <div className='flex justify-between items-center' >
                                        <div class='flex gap-4'>
                                            <button className='bg-green-100 text-green-800 flex items-center gap-1 p-1 px-2 rounded-md text-xl font-bold' > 0 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                            ...
                                            <button className='bg-red-100 text-red-800 flex items-center gap-1 p-1 px-2 rounded-md text-xl font-bold' > 0 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                            ...
                                            <button className='bg-indigo-100 text-indigo-800 flex items-center gap-2 p-1 px-2 rounded-md text-xl font-bold' > 0  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
