    ...
    return (
        <div class="w-full max-w-sm min-w-[200px]">
            <div class="relative">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.2" stroke="currentColor" class="h-5 w-5 ml-1 absolute top-5 right-2.5 text-slate-700">
